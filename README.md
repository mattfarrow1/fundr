...
[![Codecov test
coverage](https://codecov.io/gh/mattfarrow1/fundr/graph/badge.svg)](https://app.codecov.io/gh/mattfarrow1/fundr)
<!-- badges: end -->
...
- **Date utilities**: `date_interval()`, `bucket_recency()`,
  `last_weekday()`
- **File helpers**: `latest_file()`, `read_latest()`
- **Case conversion**: `to_snake_case()`, `to_title_case()`,
  `convert_names()`
